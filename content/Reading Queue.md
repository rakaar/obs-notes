...
- Mice in the Manhattan Maze: Rapid Learning, Flexible Routing and Generalization, With and Without Cortex
  - https://jieyusz.github.io/publication/manhattan

- Competition between parallel sensorimotor learning systems
  - https://elifesciences.org/articles/65361

- Understanding scientific understanding — Brain Inspired podcast
...
- Foundational Papers in Complexity Science
  - https://www.foundationalpapersincomplexityscience.org/tables-of-contents
...
- One useful framing: ask how often you would observe a difference at least this extreme under the null.
- "We could construct a test statistic that captures this domain knowledge."

### Follow-up

- Write all statistical tests in the above framework.

## Biology / genes / related

- Multiplex Gene Editing
  - https://www.lesswrong.com/posts/oSy5vHvwSfnjmC7Tf/multiplex-gene-editing-where-are-we-now?utm_source=substack&utm_medium=email

- Viviana Gradinaru lab / neuropathology drug design
  - https://glab.caltech.edu/research/

- Genomic language models

- DDM model
  - https://elifesciences.org/reviewed-preprints/96997#c51

- Neural network and spin glass
  - https://www.sciencecast.org/casts/rbw8pjzik4gn?utm_source=substack&utm_medium=email

- HG antagonistic pleiotropy
